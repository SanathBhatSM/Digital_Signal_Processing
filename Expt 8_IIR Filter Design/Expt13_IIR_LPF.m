%Matlab Program To Simulate Digital IIR LPF
clc
clear all
close all
...
ylabel('amplitude')
title('Spectrum of the music signal before lowpass filtering')
...
xlabel('frequency in Hz')
ylabel('amplitude')
title('Spectrum of the music signal after lowpass filtering')
